...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Header("Player Jumping state")]
        [Tooltip("If the character is jumping or not. Not part of the CharacterController built in jump check")]
        public bool Jumping = false;

        [Header("Player OverJumping state")]
        [Tooltip("If the character is over jumping or not. Not part of the CharacterController.")]
        public bool OverJumping = false;
        ...
        private void JumpGroundedUpdateAnimation()
        {
            // update animator if using character
            if (_hasAnimator)
            {
        ...
        private void JumpGroundedAvoidInfinitelyDrop()
        {
        ...
        private void JumpCountTimeoutDeltaDecresce()
        {
            // jump timeout
        ...
        private void JumpCountFallTimeout()
        {
            // fall timeout
        ...
        //Get All args and check if they are true
        private bool CheckForAllArguments(bool[] args = null)
        {
            bool result = true;
            if (args == null)
            {
        ...
        private void JumpAndGravity()
        {
            ...
            {
                OverJumping = false;
                JumpGroundedResetFallTimeout();
                JumpGroundedUpdateAnimation();
                JumpGroundedAvoidInfinitelyDrop();
